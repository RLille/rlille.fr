...
categories:
  ...
  - Développement
  - Bonne Pratique
image: 2021-12-02.png
image-alt: |
  Affiche de 'Être Un•e Utilisateur•rice De R Résilient•e',
  un Meetup par Maëlle Salmon,
  tenu le 2 décembre 2021
---
...
#| include: false
utils::download.file(
  url = "https://raw.githubusercontent.com/RLille/meetups/main/meetups/2021-12-02/ads/2021-12-02.png",
  destfile = "2021-12-02.png"
)
```

<!-- <center>
![Affiche Événement](2021-12-02.png)
</center> -->
...
> 
> _[Bio]_  
> Maëlle Salmon (<https://masalmon.eu/>), docteure en statistique, travaille avec R depuis des années.  
...
Celui-ci sera présenté par **Maëlle Salmon** (<https://masalmon.eu/>) sur invitation de __R Lille__ et aura lieu le **jeudi 2 décembre 2021 à 12 h 00 (CET / UTC + 1)** en ligne.
